...
<li>
                        <a class="active-menu" href="adminstudentfa.php"><i class="fa fa-bolt "></i>First Year Details</a>
                    </li>
					<li>
...
$mysql="INSERT INTO $table(Rollno, name, CGPA) VALUES ('$_POST[rollno]', '$_POST[username]','$_POST[cgpa]')";
